...
app.use("/api-docs", _swaggerUiExpress.serve, (0, _swaggerUiExpress.setup)(swaggerSpec));
app.get("/", (req, res) => {
  res.send("Welcome to the home route for the backend REST API for X fitness brand.");
});
