...
const swaggerOptions = exports.swaggerOptions = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description: "A RESTful e-commerce backend inspired by European bakeries using Express.js, Node.js, and PostgreSQL as the data layer."
    },
    servers: [{
    ...
    components: {
      ...
      schemas: {
        ...
        NewCartItemsResponse: {
          ...
          example: {
            message: "'Successfully added new product to cart.' OR 'Successfully added product to cart.'",
            addedProduct: {
              id: 101,
              cart_id: 88,
              product_id: 3,
        ...
        GetProdsByCategory: {
          ...
          example: {
            ...
            products: [{
              name: "Sourdough Loaf",
              description: "Naturally leavened bread made with a fermented starter containing wild yeast and bacteria, resulting in a tangy flavor and chewy texture.",
              price: "5.99",
              stock: 50,
              category_id: 1
            }, {
        ...
        User: {
          ...
          example: {
            ...
            password: "$2b$11$rHowWbwkyFdcl4hEGLvE3eAv5uFU9DlQ4EOywnbwG5D5kR7mHAdQW",
            first_name: "Billy",
            last_name: "Robert",
            address: "Houston, TX",
        ...
        AllUsers: {
          ...
          example: [{
            ...
            password: "$2b$11$rHoasdfwkyFdcl4hEGLvE3eAv5uFU9DlQ4EOywnbwG5D5kR7mHAdQW",
            first_name: "John",
            last_name: "Doe",
            ...
            password: "$2b$11$rHowWbwkyFdcl4hEGLvE3eAv5uFU9Dasd8EOywnbwG5D5kR7mHAdQW",
            first_name: "Sara",
            last_name: "Miller",
            address: "New York, NY",
            ...
            password: "$2b$11$rHowWbwkyFdcl4hEGLvE3eAv5uFU9DlQ4asdf0wnbwG5D5kR7mHAdQW",
            first_name: "Bruce",
            last_name: "Wayne",
            address: "Gotham, NY",
